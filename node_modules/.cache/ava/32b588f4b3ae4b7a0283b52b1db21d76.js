...
test(function (t) {
  return request.post('/').send().expect(200).expect(function (res) {
    var _rec = new _powerAssertRecorder();

    console.log(res.body);
    t.truthy(_rec._expr(_rec._capt(_rec._capt(res, 'arguments/0/object').body, 'arguments/0'), {
      content: 't.truthy(res.body)',
      filepath: 'test/tests.js',
      line: 11,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"truthy","range":[2,8]},"computed":false,"range":[0,8]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"res","range":[9,12]},"property":{"type":"Identifier","name":"body","range":[13,17]},"computed":false,"range":[9,17]}],"range":[0,18]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"truthy","range":[2,8]},{"type":{"label":"("},"range":[8,9]},{"type":{"label":"name"},"value":"res","range":[9,12]},{"type":{"label":"."},"range":[12,13]},{"type":{"label":"name"},"value":"body","range":[13,17]},{"type":{"label":")"},"range":[17,18]}]',
      visitorKeys: _powerAssertVisitorKeys
    }));
  });
});
//# sourceMappingURL=../node_modules/.cache/ava/32b588f4b3ae4b7a0283b52b1db21d76.js.map