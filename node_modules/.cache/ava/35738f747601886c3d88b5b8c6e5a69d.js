...
function connect(t) {
  return request.post('/').send({
    ...
    t.is(_rec._expr(_rec._capt(_rec._capt(_rec._capt(res, 'arguments/0/object/object').body, 'arguments/0/object').status, 'arguments/0'), {
      content: 't.is(res.body.status, \'Connected\')',
      filepath: 'test/repetitive-connection.test.js',
      line: 21,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"res","range":[5,8]},"property":{"type":"Identifier","name":"body","range":[9,13]},"computed":false,"range":[5,13]},"property":{"type":"Identifier","name":"status","range":[14,20]},"computed":false,"range":[5,20]},{"type":"StringLiteral","value":"Connected","range":[22,33]}],"range":[0,34]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"res","range":[5,8]},{"type":{"label":"."},"range":[8,9]},{"type":{"label":"name"},"value":"body","range":[9,13]},{"type":{"label":"."},"range":[13,14]},{"type":{"label":"name"},"value":"status","range":[14,20]},{"type":{"label":","},"range":[20,21]},{"type":{"label":"string"},"value":"Connected","range":[22,33]},{"type":{"label":")"},"range":[33,34]}]',
...
function close(t) {
  return request.post('/').send({
    ...
    t.is(_rec2._expr(_rec2._capt(_rec2._capt(_rec2._capt(res, 'arguments/0/object/object').body, 'arguments/0/object').status, 'arguments/0'), {
      content: 't.is(res.body.status, \'Connection closed\')',
      filepath: 'test/repetitive-connection.test.js',
      line: 34,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"res","range":[5,8]},"property":{"type":"Identifier","name":"body","range":[9,13]},"computed":false,"range":[5,13]},"property":{"type":"Identifier","name":"status","range":[14,20]},"computed":false,"range":[5,20]},{"type":"StringLiteral","value":"Connection closed","range":[22,41]}],"range":[0,42]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"res","range":[5,8]},{"type":{"label":"."},"range":[8,9]},{"type":{"label":"name"},"value":"body","range":[9,13]},{"type":{"label":"."},"range":[13,14]},{"type":{"label":"name"},"value":"status","range":[14,20]},{"type":{"label":","},"range":[20,21]},{"type":{"label":"string"},"value":"Connection closed","range":[22,41]},{"type":{"label":")"},"range":[41,42]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), 'Connection closed');
  });
}
//# sourceMappingURL=../node_modules/.cache/ava/35738f747601886c3d88b5b8c6e5a69d.js.map