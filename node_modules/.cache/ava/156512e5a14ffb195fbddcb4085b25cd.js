...
test.serial('wrong pass', function (t) {
  return request.post('/').send({
    ...
    t.is(_rec._expr(_rec._capt(_rec._capt(_rec._capt(JSON, 'arguments/0/object/callee/object').parse(_rec._capt(_rec._capt(_rec._capt(res, 'arguments/0/object/arguments/0/object/object').error, 'arguments/0/object/arguments/0/object').text, 'arguments/0/object/arguments/0')), 'arguments/0/object').error, 'arguments/0'), {
      content: 't.is(JSON.parse(res.error.text).error, \'Connection success\')',
      filepath: 'test/wrong-pass.test.js',
      line: 15,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"MemberExpression","object":{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"JSON","range":[5,9]},"property":{"type":"Identifier","name":"parse","range":[10,15]},"computed":false,"range":[5,15]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"res","range":[16,19]},"property":{"type":"Identifier","name":"error","range":[20,25]},"computed":false,"range":[16,25]},"property":{"type":"Identifier","name":"text","range":[26,30]},"computed":false,"range":[16,30]}],"range":[5,31]},"property":{"type":"Identifier","name":"error","range":[32,37]},"computed":false,"range":[5,37]},{"type":"StringLiteral","value":"Connection success","range":[39,59]}],"range":[0,60]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"JSON","range":[5,9]},{"type":{"label":"."},"range":[9,10]},{"type":{"label":"name"},"value":"parse","range":[10,15]},{"type":{"label":"("},"range":[15,16]},{"type":{"label":"name"},"value":"res","range":[16,19]},{"type":{"label":"."},"range":[19,20]},{"type":{"label":"name"},"value":"error","range":[20,25]},{"type":{"label":"."},"range":[25,26]},{"type":{"label":"name"},"value":"text","range":[26,30]},{"type":{"label":")"},"range":[30,31]},{"type":{"label":"."},"range":[31,32]},{"type":{"label":"name"},"value":"error","range":[32,37]},{"type":{"label":","},"range":[37,38]},{"type":{"label":"string"},"value":"Connection success","range":[39,59]},{"type":{"label":")"},"range":[59,60]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), 'Connection success');
  });
});
//# sourceMappingURL=../node_modules/.cache/ava/156512e5a14ffb195fbddcb4085b25cd.js.map